...
var data = {  
   ...
   "height":"6\" 1'"
            ...
            link.onclick = function() {
                ...
                sst[5].innerHTML = data.stats[5].name;
                sst[6].innerHTML = data.stats[6].name;
                sst[7].innerHTML = data.stats[7].name;
                sst[8].innerHTML = data.stats[8].name;
                ...
                sst[5].innerHTML = data.stats[5].value + ' (' + data.stats[5].rank + ')';
                sst[6].innerHTML = data.stats[6].value + ' (' + data.stats[6].rank + ')';
                sst[7].innerHTML = data.stats[7].value + ' (' + data.stats[7].rank + ')';
                sst[8].innerHTML = data.stats[8].value + ' (' + data.stats[8].rank + ')';
